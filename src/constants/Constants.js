...
export const DISPLAY_ARTEFACT_DETAILS_SUBGROUP = "display_artefact_details_subgroup";
export const DISPLAY_ARTEFACT_DETAILS_HEADING = "display_artefact_details_heading";
export const DISPLAY_ARTEFACT_DETAILS_SUBHEADING = "display_artefact_details_subheading";
